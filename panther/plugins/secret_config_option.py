...
'None' are explicitly set, Panther will return a MEDIUM confidence issue. If
Panther can't determine the value of secret it will return a LOW confidence
issue.
