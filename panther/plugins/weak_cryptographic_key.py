...
def _classify_key_size(config, key_type, key_size):
    ...
    key_sizes = {
        'DSA': [(config['weak_key_size_dsa_high'], panther.HIGH),
                (config['weak_key_size_dsa_medium'], panther.MEDIUM)],
        'RSA': [(config['weak_key_size_rsa_high'], panther.HIGH),
                (config['weak_key_size_rsa_medium'], panther.MEDIUM)],
        'EC': [(config['weak_key_size_ec_high'], panther.HIGH),
               (config['weak_key_size_ec_medium'], panther.MEDIUM)],
    }
