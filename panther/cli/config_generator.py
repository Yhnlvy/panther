...
PROG_NAME = 'panther_conf_generator'
LOG = logging.getLogger(__name__)


template = """
### Panther config file generated from:
# '{cli}'
...
### that may be given here, per-plugin. All panther test plugins have a built in
...
def parse_args():
    help_description = """Panther Config Generator
    ...
    will be used.  Panther will prefer settings from the profile over the built
    in values."""
